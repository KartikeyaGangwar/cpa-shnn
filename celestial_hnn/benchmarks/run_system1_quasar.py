...
def run_system1_benchmark(device=None):
    print("\n" + "#"*70)
    print("  SYSTEM 1 BENCHMARK: BINARY QUASAR HAMILTONIAN DYNAMICS")
    print("#"*70)
    system = BinaryQuasarHamiltonianSystem(device=device)
    ...
    results = {
        "system": "BinaryQuasarHamiltonianSystem",
        "standard_mlp": mlp_res,
        "hnn_symplectic": hnn_res,
    }
    os.makedirs("results/data", exist_ok=True)
    with open("results/data/system1_quasar_hnn.json", "w") as f:
